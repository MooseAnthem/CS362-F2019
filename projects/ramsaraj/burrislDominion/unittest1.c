...
int main() {
    ...
    printf("*****Beginning doMine() Testing*****\n");
    ...
    G.handCount[0] = 5;
    P = G;  //Save state
    success = doMine(0, 3, village, &G, 4);
    ...
    G.handCount[0] = 5;
    P = G;  //Save state
    success = doMine(0, 3, tribute, &G, 4);
