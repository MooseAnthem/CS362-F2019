...
int main(int argc, char* argv[]) {
    ...
    for (int i = 0; i < iterations; i++) {
        ...
        tributeRevealedCards[0] = tributeRevealedCards[1] = -1; //Reset tributeRevealedCards to default like `playCard()` would
        numPlayers = (rand() % 3) + 2;
        ...
        doTribute(G.whoseTurn, nextPlayer, tributeRevealedCards, 0, 0, &G, 0);
        int failed = FALSE;
        ...
        //  deck array should be potentially modified by doTribute:
